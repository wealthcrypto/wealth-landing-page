    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
        <motion.div
          ...
          className="absolute top-24 left-[8%] md:left-1/4 w-20 h-20 md:w-32 md:h-32"
        >
          <Image src={Growth} alt="growth" className="w-full h-full" />
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute bottom-2/4 left-[10%] md:left-1/4 w-20 h-20 md:w-32 md:h-32"
        >
          <Image
            src={RedCircle}
            alt="circle"
        ...
        <motion.div
          ...
          className="absolute bottom-32 md:bottom-2/4 right-8 md:right-72 h-32 w-32 md:w-32 md:h-32"
        >
          <Image src={Ascend} alt="ascend" className="w-full h-full" />
        </motion.div>
      ...
      >
        ...
        >
          One currency for the life you love. From your morning coffee to
          nightlife, events, and travel. $WEALTH transforms daily experiences
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mt-8 md:mt-14">
          <div className="flex flex-col items-center justify-center md:justify-between h-32 md:h-40 ">
            <div
              aria-hidden="true"
