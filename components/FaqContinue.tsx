...
const FaqContinue = () => {
  return (
    <div className="bg-[#19CC85] w-dvw">
      <div className="w-full flex flex-col lg:flex-row justify-between items-center p-2 gap-8 lg:gap-0">
        <div className="flex flex-col p-4 text-white w-full lg:max-w-lg space-y-4 lg:space-y-6 text-center lg:text-left">
          <div className="">
          ...
          <div className="flex justify-center lg:justify-start">
            <a href="mailto:hi@wealthcrypto.fund" className="inline-block">
              <div className="mt-4 lg:mt-6 bg-transparent font-bold pr-2 pl-4 lg:pl-6 text-white py-2 lg:py-2 rounded-full border-2 border-white transition flex gap-2 lg:gap-3 items-center hover:bg-white hover:border-2 hover:border-[#1dcb86] hover:text-[#1dcb86] group">
                ...
                <div className="transform rotate-[-45deg] bg-white rounded-full p-2 text-[#1dcb86] group-hover:bg-[#1dcb86] group-hover:text-white transition-colors">
        ...
        <div className="w-full md:w-1/2 min-h-full flex justify-end pr-2">
          <Image 
            src={JoinImages} 
            alt="Join Images" 
