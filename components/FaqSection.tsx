...
const FaqSection = () => {
    ...
    const ListContent: FaqContent[] = [
        {
            title: "What is WealthCrypto and how does it work?",
            description: `WealthCrypto is your digital key to premium lifestyle experiences. Think of it like a membership card that gives you access to curated sports, music, dining, and community events. The more WEALTH you hold, the more exclusive experiences become available to you.`
        },
        {
            title: "How do I get WealthCrypto?",
