  ...
  return (
    ...
    >
      ...
      <div className="space-y-2 text-black mt-6 sm:mt-8 md:mt-12">
        <p className="font-body text-3xl sm:text-4xl md:text-5xl">Lifestyle</p>
        <p className="font-reflet text-4xl sm:text-5xl md:text-7xl">first</p>
      ...
      >
        ...
        <div className="space-y-2 text-white mt-6 sm:mt-8 md:mt-12">
          <p className="font-body text-3xl sm:text-4xl md:text-5xl">Curated</p>
          <p className="font-reflet text-4xl sm:text-5xl md:text-7xl">Experiences</p>
          <p className="font-body text-xs sm:text-sm w-10/12">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
            nonummy nibh euismod tincidunt ut laoreet dolore magna
          </p>
      ...
      >
        ...
        <div className="space-y-2 text-white mt-6 sm:mt-8 md:mt-12">
          <p className="font-body text-3xl sm:text-4xl md:text-5xl">Community</p>
          <p className="font-reflet text-4xl sm:text-5xl md:text-7xl">driven</p>
          <p className="font-body text-xs sm:text-sm w-10/12">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
            nonummy nibh euismod tincidunt ut laoreet dolore magna
          </p>
      ...
      >
        ...
        <div className="space-y-2 text-black mt-6 sm:mt-8 md:mt-12">
          <p className="font-body text-3xl sm:text-4xl md:text-5xl">Your</p>
          <p className="font-reflet text-4xl sm:text-5xl md:text-7xl">journey</p>
          <p className="font-body text-xs sm:text-sm w-10/12">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam
            nonummy nibh euismod tincidunt ut laoreet dolore magna
          </p>
